...
from django.http import HttpResponseServerError, HttpResponseBadRequest, \
    HttpResponseNotFound, HttpResponseForbidden, HttpResponse
...
class Root(BaseStorageView):
    ...
    def get(self, request):
        if len(request.GET) < 1:
            ...
            return render_to_response('annotator/annotate_list.html', {'docs': doc_list, 'users': User.objects.exclude(username='admin').exclude(first_name='')}, context_instance=RequestContext(request))
        else:
